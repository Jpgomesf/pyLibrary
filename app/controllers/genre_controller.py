...
def register_genre_routes(app, prefix=''):
    @app.route(f'{prefix}/genres', methods=['POST'])
    def add_genre():
    ...
    @app.route(f'{prefix}/genres/<int:id>', methods=['DELETE'])
    def delete_genre(id):
